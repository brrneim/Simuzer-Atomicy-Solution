...
namespace Atomicy.App.Services.Base
{
    public class BaseDataService
    {
        protected readonly ILocalStorageService _localStorage;
        
        protected IAtomicyManagementAPIClient _client;

        public BaseDataService(IAtomicyManagementAPIClient client, ILocalStorageService localStorage)
        {
            _client = client;
